...
function Header() {
  ...
  return (
    <>
      ...
      <div className='w-full select-none block px-3 py-1 lg:hidden h-[550px] bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url(${bg_img})` }}>
...
{/* ///////////// */}
        <div className={`w-max py-1 mt-45 px-4 anime_yx bg-black/80 rounded-3xl  text-white flex items-center gap-5 transition-all duration-400 ease-in  `} style={{ animationDelay: ".3s" }}>
          <div className='w-[10px] h-[10px] rounded-full bg-red-500'></div>
          <p className='text-white text-md tracking-[.5px] capitalize font-bold '>Specializing in responsive web applications</p>
        </div>
...
{/* ///////////// */}
{/* lg k nechy header ko set krna ha  */}

        <div className=' justify-center items-center w-full h-max border hidden'>
          <div className='w-[15.5%] h-[43%] shadow-md shadow-black p-3 bg-black rounded-3xl '>
            <h1 className='text-center text-2xl '>🧩</h1>
            <h1 className='text-white text-lg xl:text-xl font-bold text-center underline mt-1'>Latest Project</h1>
            <div className="w-full h-[70px] flex items-center justify-center ">
              <div className="w-full h-full max-w-5xl rounded-xl ">
          ...
          <div className='w-[16.5%] h-[21%] shadow-md shadow-red-500 bg-red-500 rounded-3xl  text-white text-8xl flex justify-center items-center'> <FaReact className='tr_r' /> </div>
          <div className='w-[32.5%] h-[28%] shadow-md shadow-black bg-black rounded-3xl  p-3'>
